  ...
  return (
    <section className="paddingX max-w-7xl mx-auto py-24 relative" id="experience">
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-12 w-full">
        ...
        <div className="md:w-1/3 flex md:flex-col overflow-x-auto md:overflow-visible gap-4 pb-4 md:pb-0 scrollbar-hide">
        ...
        <div className="md:w-2/3 min-h-[500px] relative">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-6 md:p-8"
            >
