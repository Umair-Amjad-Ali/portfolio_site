                    ...
                    >
                        <div>
                            ...
                            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                                Innovation <span className="gradient-text-vibrant">Archive</span>
                            </h1>
                            <p className="text-gray-400 text-lg max-w-2xl">
                                A complete collection of engineering challenges, system designs, and performance optimizations.
                            </p>
                        </div>
                    </motion.div>
                </div>
                            ...
                            <div className="p-8 flex flex-col h-full relative z-10">
                                ...
                                <div className="pt-6 border-t border-slate-800/50 mt-4">
                                    ...
                                    >
                                        ...
                                        <div className="transform rotate-180"><FaArrowLeft size={12} /></div>
                                    </button>
                                </div>
                            </div>
                        </motion.div>
