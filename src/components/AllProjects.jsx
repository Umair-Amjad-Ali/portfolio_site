        ...
        <div className="min-h-screen bg-[#0a0e27] py-20">
            <div className="sm:px-16 px-6 max-w-7xl mx-auto">
                ...
                >
                    <Link
                        to="/"
                        className="inline-flex items-center gap-2 text-indigo-400 hover:text-indigo-300 mb-6 transition-colors no-underline"
                    >
                        <FaArrowLeft />
                        Back to Home
                    </Link>
                    ...
                    <p className="text-gray-400 text-lg max-w-2xl">
                        A complete collection of my work — from AI-powered apps to full-stack
                        web platforms. Each project showcases different skills and
