        ...
        >
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-20">
                    ...
                    >
                        Engineering <span className="gradient-text-vibrant">Deep Dives</span>
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Behind every beautiful UI is a robust system. Here's how I solve complex
                        engineering challenges, scale architecture, and optimize performance.
                    </motion.p>
                </div>
                            ...
                            <div className="p-8 flex flex-col h-full relative z-10">
                                ...
                                <div className="mb-auto">
                                    ...
                                    <div className="flex items-center gap-2 mb-4 text-sm text-gray-500">
                                        ...
                                        <span>Powered by <span className="text-gray-300 font-medium">{dive.mainTech}</span></span>
                                    </div>
                                ...
                                <div className="pt-6 border-t border-slate-800/50 mt-4">
                                    <div className="flex flex-wrap gap-2 mb-6">
                                        {dive.tags.slice(0, 3).map((tag, tIndex) => (
                                            <span key={tIndex} className="text-[10px] text-gray-500 bg-slate-900 px-2 py-1 rounded border border-slate-800">
                                                #{tag}
                                            </span>
                                        ))}
                                    </div>
                ...
                >
                    <Link
                        to="/deep-dives"
                        className="inline-flex items-center gap-2.5 px-6 py-3 bg-slate-800 hover:bg-slate-700 rounded-xl text-white text-sm font-semibold transition-all duration-300 border border-slate-700 hover:border-slate-600 mb-6"
                    >
                        View All Deep Dives
